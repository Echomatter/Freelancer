...
export function executionPrompt(agent, workflow, metadata, catalog) {
  ...
  return [
    ...
    "Delegate waits for its child. Continue useful specialists with worker and task. Preserve partial results and investigate repeated failures or uncertain stops before retrying.",
